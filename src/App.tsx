...
import { countPendingVerifications, createOpenSubmission, createTask, documentPreviewUrl, loadSubmissions, loadTasks, persistAssignmentStatus, persistTaskActive, reviewSubmission, submitLinkSubmission, transferSubmission, type SubmissionRecord } from './lib/repository'
...
function App() {
  ...
  return <div className="app-shell">
    {view==='admin'
      ...
      : telaahOpen?<TelaahPublicPage onBack={()=>setTelaahOpen(false)} setView={setView}/>:<SatkerView tasks={tasks} selectedSatker={selectedSatker} setSelectedSatker={setSelectedSatker} setView={setView} detail={detail} setDetail={setDetail} flash={flash} onOpenTelaah={()=>setTelaahOpen(true)}/>
    }
...
function SatkerView({tasks,selectedSatker,setSelectedSatker,setView,detail,setDetail,flash,onOpenTelaah}:SharedProps&{flash:(s:string)=>void;onOpenTelaah:()=>void}){
